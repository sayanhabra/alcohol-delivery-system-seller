...
void main() {
  group('CheckPhoneResponse parsing tests', () {
    ...
    test('Parse Response 2: User exists, OTP sent successfully (OTP_VERIFICATION)', () {
      final json = {
        "statusCode": 200,
        "message": "User exists, OTP sent successfully",
        "response": {
          "nextStep": "OTP_VERIFICATION",
          "challengeToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwaG9uZSI6Ijg0MzYxODkxODIiLCJuZXh0U3RlcCI6Ik9UUF9WRVJJRklDQVRJT04iLCJpYXQiOjE3ODYyOTQ2MDAsImV4cCI6MTc4NjI5NDkwMH0.ZJ4zrLxs9V_fkHbf-MXN896e867QD4n17A-dVKi_7kQ",
      ...
      expect(response.challengeToken, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwaG9uZSI6Ijg0MzYxODkxODIiLCJuZXh0U3RlcCI6Ik9UUF9WRVJJRklDQVRJT04iLCJpYXQiOjE3ODYyOTQ2MDAsImV4cCI6MTc4NjI5NDkwMH0.ZJ4zrLxs9V_fkHbf-MXN896e867QD4n17A-dVKi_7kQ");
